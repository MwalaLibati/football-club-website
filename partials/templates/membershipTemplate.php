                                                  ...
                                                  <tr>
                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img class="max-width" border="0"
                                                                ...
                                                                src="https://web-remote-resources.netlify.app/mwfc/mwfc_logo.png"
                                                                height="27">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      ...
                                                      <table class="wrapper" role="module" data-type="image" border="0"
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="line-height:0px; padding:0px 0px 0px 0px;"
                                                              valign="top" align="center">
                                                              <h2>Mufulira Wanderers FC</h2>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <img width="100" height="100" src="https://web-remote-resources.netlify.app/mwfc/' . $memberType . '.jpg" alt="">
                                                                  <br>
                                                                  <span style="font-size: 30px">
                                                                    Congratulations ' . $firstName . '! 
                                                                    <hr style="width: 60%;">
                                                                    You are now a <br> ' . $memberType . ' Member.
                                                                  </span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">We are very happy to have you on board.</span><span
                                                                    style="font-size: 18px"></span></div>
                                                                    <br>
                                                                    <div style="text-align: center;"><b>Reference No:</b> ' . $membNo . '</div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                ...
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="color: #ffffff; font-size: 18px">
                                                                    Be sure to check the invoice we have emailed to you.
                                                                  </span>
                                                                </div>
                                                                ...
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="color: #ffffff; font-size: 18px">
                                                                    Need help or assistance? Our support team is always here to help
                                                                  </span>
                                                                </div>
                                      ...
                                      <div data-role="module-unsubscribe" class="module" role="module"
                                        ...
                                        <div class="Unsubscribe--addressLine">
                                          <p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">
                                            &copy; ' . date("Y") . ' Mufulira Wanderers
                                            FC. All rights reserved
                                          </p>
                                          <p class="f-fallback sub align-center"
                                            style="font-size:12px; line-height:20px; color: #444444;">
                                            &#9990;
                                            <a href="tel:+260977777777" style="color: #444444;">+260977777777</a>
                                            /
                                            <a href="tel:+260966666666" style="color: #444444;">+260966666666</a>
                                          </p>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                                      ...
                                                      Powered by:
                                                      <br>
                                                      <a target="_blank" class="no_loader"
                                                        href="https://joshuakosamu.netlify.app">
                                                        <img style="width:40px;height:40px;padding:0px; margin:0px;"
                                                          src="https://web-remote-resources.netlify.app/jdslk/jdslk_logo.png"
                                                          alt="Jdslk">
                                                      </a>
                                                    </td>
                                                  </tr>
